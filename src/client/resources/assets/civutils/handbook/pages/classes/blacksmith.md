...
The Blacksmith's main role is to craft upgraded tools and armor for players. Any player can craft wooden tools, but only a Blacksmith can craft tools made of better materials (stone, iron, diamond, etc.). Blacksmiths are also the only class capable of using an anvil.
...
1. **Early Game:** Smelt logs into charcoal for XP without hunger cost
2. **Prioritize Guardsmen:** Give them the best equipment first
3. **Stay Safe:** Blacksmiths are crucial - don't risk dying and losing progress
4. **Stockpile:** Create extra tools when resources allow
