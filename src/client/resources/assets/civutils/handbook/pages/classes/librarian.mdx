...
> **Note:** Librarians gain Ender Chest access at Expert (3). All other classes unlock Ender Chests at Grandmaster (5). Players below the required level can still **remove** items from their Ender Chest, but cannot store items.

### Master (4)

<Unlocks class="librarian" level="4" />

**Other:** **Speed III**, Diamond Gear Blueprints
